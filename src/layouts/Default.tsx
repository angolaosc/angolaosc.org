...
import SideBar from '../components/componetsAluno/SideBar/SideBar'
...
export default function Default() {
    ...
    const menus = [
        { name: "Home", link: "/HomeAluno", icon: HomeOutlinedIcon },
        { name: "Sebentas", link: "Sebentas", icon:ClassOutlinedIcon },
